...
pub fn load_env_map(
    ...
    let gha_indie_worker_api_bind = pick(&["GHA_INDIE_WORKER_API_BIND"], &["flags", "env_shell", "env_file"], shell, dotenv, flags, None);
    if let Some(value) = gha_indie_worker_api_bind {
        out.insert("GHA_INDIE_WORKER_API_BIND".to_string(), value);
    }
